...
// IngestionService handles the actual ingestion of Twitter data
...
func (s *IngestionService) IngestUserData(ctx context.Context, userID uuid.UUID) error {
...
func (s *IngestionService) performIngestion(ctx context.Context, userID uuid.UUID, runID string, startCursor string) (int, error) {
...
func (s *IngestionService) ingestFollowing(ctx context.Context, userID uuid.UUID, runID string) (int, error) {
...
func (s *IngestionService) ingestTweets(ctx context.Context, userID uuid.UUID, runID string, startCursor string) (int, error) {
	...
	for _, follow := range following {
		...
		if author == nil || author.Handle == nil {
...
func (s *IngestionService) ingestTweetsForAuthor(ctx context.Context, userID uuid.UUID, authorHandle string, cursor string) (int, string, error) {
...
func (s *IngestionService) ensureAuthorExists(ctx context.Context, user *UserData) (int64, error) {
